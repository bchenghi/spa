...
TEST_CASE("simple::Tokenizer", "[simple]") {
    SECTION("should tokenize simple query") {
        ...
        vector<Token> expected = {
                Token(TokenType::NAME, "procedure", 1),
                ...
                Token(TokenType::NAME, "procedure", 24),
