...
using pql::AffectsBipClause;
using pql::FilterResult;
using pql::PkbAbstractor;

AffectsBipClause::AffectsBipClause(QueryArg firstArg, QueryArg secondArg) : SuchThatClause(firstArg, secondArg) {
...
FilterResult AffectsBipClause::executePKBAbsQuery(PkbAbstractor *pkbAbstractor) {
    int stmtNum;
    int stmtNum1;
