...
declare -a testsuites=(
    ...
    "./base/extension/NextBip/"
    "./base/extension/NextBipStar/"
    "./base/extension/AffectBip/"
    "./base/extension/AffectBipStar/"
    ...
    "./iter1-system-tests/non_nested_"
    "./iter1-system-tests/nested_"
    "./iter1-system-tests/multi_nested_"
    "./non_nested_"
    "./nested_"
    "./multi_nested_"
    "./edge_cases/keywords/"
